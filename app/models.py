...
class AdPost(models.Model):
    title = models.CharField(max_length=255, blank=True, null=True)
    category = models.ForeignKey(Categories, on_delete=models.CASCADE, related_name='post_ad_category', blank=True,
                                 null=True)
    location = models.ForeignKey(Location, on_delete=models.CASCADE, related_name='post_ad_location', blank=True,
                                 null=True)
    ...
    seller = models.ForeignKey(SellerInformation, on_delete=models.CASCADE, related_name='post_ad_seller', blank=True,
                               null=True)
    featured_image = models.ImageField(upload_to=content_file_name, null=True)
    is_active = models.BooleanField(default=False)
    created_by = models.ForeignKey(User, on_delete=models.CASCADE, related_name='post_add_created', blank=True,
                                   null=True)
    updated_by = models.ForeignKey(User, on_delete=models.CASCADE, related_name='post_add_updated', blank=True,
                                   null=True)
    created = models.DateTimeField(auto_now_add=True, auto_now=False, blank=True, null=True)
    updated = models.DateTimeField(auto_now_add=True, auto_now=False, blank=True, null=True)
...
class Ads_Image(models.Model):
    ...
    post_ad = models.ForeignKey(AdPost, on_delete=models.CASCADE, related_name='ads_image_post_ad', blank=True,
                                null=True)
    created = models.DateTimeField(auto_now_add=True, auto_now=False)
    updated = models.DateTimeField(auto_now_add=True, auto_now=False)
